            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);">
                        <i class="mdi mdi-tire"></i>
                        <span> Tyre Management </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="transport_dashboard.php">Distribute Tyres</a></li>
                        <li><a href="tyre_assignment.php">View Assignments</a></li>
                        <li><a href="tyre_stock_report.php">Tyre Stock Report</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="vehicle_service.php">Service Records</a></li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="issue_items.php">Issue Items</a></li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="diesel_report.php">Diesel Report</a></li>
